...
* [Typst](https://github.com/typst/typst) ⭐ 56,105 | 🐛 1,285 | 🌐 Rust | 📅 2026-09-18 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,363 | 🐛 3 | 🌐 TeX | 📅 2026-09-18. A modern Vim and neovim filetype plugin for LaTeX files
* [goyo](https://github.com/junegunn/goyo.vim) ⭐ 4,687 | 🐛 80 | 🌐 Vim Script | 📅 2025-12-21. Distraction-free writing in Vim. Also [limelight](https://github.com/junegunn/limelight.vim) ⭐ 2,452 | 🐛 25 | 🌐 Vim Script | 📅 2026-03-09 by the same author
...
* [Paramount](https://github.com/owickstrom/vim-colors-paramount) ⭐ 276 | 🐛 2 | 🌐 Vim script | 📅 2019-01-09
