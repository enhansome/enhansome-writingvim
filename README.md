...
* [Typst](https://github.com/typst/typst) ⭐ 55,526 | 🐛 1,274 | 🌐 Rust | 📅 2026-08-17 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimwiki](https://github.com/vimwiki/vimwiki) ⭐ 9,508 | 🐛 230 | 🌐 Vim Script | 📅 2026-04-30. Personal Wiki for Vim
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,348 | 🐛 2 | 🌐 TeX | 📅 2026-08-15. A modern Vim and neovim filetype plugin for LaTeX files
...
* [vim galore](https://github.com/mhinz/vim-galore) ⭐ 17,946 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22
