...
* [Typst](https://github.com/typst/typst) ⭐ 55,872 | 🐛 1,284 | 🌐 Rust | 📅 2026-09-05 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [goyo](https://github.com/junegunn/goyo.vim) ⭐ 4,688 | 🐛 80 | 🌐 Vim Script | 📅 2025-12-21. Distraction-free writing in Vim. Also [limelight](https://github.com/junegunn/limelight.vim) ⭐ 2,451 | 🐛 25 | 🌐 Vim Script | 📅 2026-03-09 by the same author
