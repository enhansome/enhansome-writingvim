...
* [Typst](https://github.com/typst/typst) ⭐ 55,901 | 🐛 1,286 | 🌐 Rust | 📅 2026-09-07 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,351 | 🐛 2 | 🌐 TeX | 📅 2026-09-05. A modern Vim and neovim filetype plugin for LaTeX files
