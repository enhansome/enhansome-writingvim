...
* [Typst](https://github.com/typst/typst) ⭐ 56,266 | 🐛 1,287 | 🌐 Rust | 📅 2026-09-24 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,372 | 🐛 1 | 🌐 TeX | 📅 2026-09-25. A modern Vim and neovim filetype plugin for LaTeX files
