...
* [Typst](https://github.com/typst/typst) ⭐ 56,247 | 🐛 1,284 | 🌐 Rust | 📅 2026-09-24 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,372 | 🐛 2 | 🌐 TeX | 📅 2026-09-25. A modern Vim and neovim filetype plugin for LaTeX files
* [goyo](https://github.com/junegunn/goyo.vim) ⭐ 4,688 | 🐛 80 | 🌐 Vim Script | 📅 2025-12-21. Distraction-free writing in Vim. Also [limelight](https://github.com/junegunn/limelight.vim) ⭐ 2,452 | 🐛 25 | 🌐 Vim Script | 📅 2026-03-09 by the same author
* [abolish](https://github.com/tpope/vim-abolish) ⭐ 2,961 | 🐛 38 | 🌐 Vim Script | 📅 2024-08-07. Fancy find and replace :+1:
...
* [vim-paper](https://github.com/yorickpeterse/vim-paper) ⭐ 176 | 🐛 0 | 🌐 Vim Script | 📅 2025-02-15 :eyes:
* [Paige](https://sr.ht/~leon_plickat/Paige/)
* [Bruin](https://git.sr.ht/~romainl/vim-bruin)

## general vim resources

* [vim galore](https://github.com/mhinz/vim-galore) ⭐ 17,996 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22
* [Idiomatic Vimrc: Advice on writing your own config](https://github.com/romainl/idiomatic-vimrc) ⭐ 1,198 | 🐛 0 | 📅 2023-05-19 - romainl
