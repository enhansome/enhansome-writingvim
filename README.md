...
* [Typst](https://github.com/typst/typst) ⭐ 55,456 | 🐛 1,270 | 🌐 Rust | 📅 2026-08-14 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimwiki](https://github.com/vimwiki/vimwiki) ⭐ 9,505 | 🐛 232 | 🌐 Vim Script | 📅 2026-04-30. Personal Wiki for Vim
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,343 | 🐛 8 | 🌐 TeX | 📅 2026-08-14. A modern Vim and neovim filetype plugin for LaTeX files
...
* [vim-no-color-collection](https://github.com/mcchrish/vim-no-color-collections) ⭐ 1,058 | 🐛 1 | 📅 2026-01-25 Collection of Vim themes with barely any colors
