...
* [Typst](https://github.com/typst/typst) ⭐ 55,743 | 🐛 1,276 | 🌐 Rust | 📅 2026-08-28 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,353 | 🐛 2 | 🌐 TeX | 📅 2026-08-29. A modern Vim and neovim filetype plugin for LaTeX files
...
* [vim galore](https://github.com/mhinz/vim-galore) ⭐ 17,967 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22
