...
* [Typst](https://github.com/typst/typst) ⭐ 56,014 | 🐛 1,293 | 🌐 Rust | 📅 2026-09-14 Typst is a new markup-based typesetting system designed to be “as powerful as LaTeX while being much easier to learn and use”
...
* [vimtex](https://github.com/lervag/vimtex) ⭐ 6,362 | 🐛 2 | 🌐 TeX | 📅 2026-09-14. A modern Vim and neovim filetype plugin for LaTeX files
...
* [vim-no-color-collection](https://github.com/mcchrish/vim-no-color-collections) ⭐ 1,066 | 🐛 1 | 📅 2026-01-25 Collection of Vim themes with barely any colors
...
* [vim galore](https://github.com/mhinz/vim-galore) ⭐ 17,976 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22
